...
def _cmd_preheat_temp(ctl: VMICtl, args: list[str]) -> int:
    _require_args(args, 1, "preheat-temp requires a temperature value (12-18 or 'mini')")
    shot = ctl.ui.preheat_temp(args[0])
