...
| Mode Select (0x10, param 0x18) | Yes | Yes | `build_sensor_select_request(mode)` — controls fan speed + sensor select. Physical speed change verified via vibration sensor 2026-02-08 ([#22](https://github.com/bartcortooms/visionair-ble/issues/22)) |
